...
type GreenTrackMarkProps = {
  size?: number;
  className?: string;
  style?: CSSProperties;
};

// GreenTrack のロゴマーク（3本のリーフを傾けたモチーフ）。
...
// viewBox の値は rotate(-22) 後の3本のバウンディングボックス（元データ greentrack-mark.svg 由来）。
export const GreenTrackMark = ({ size = 24, className, style }: GreenTrackMarkProps) => (
  <svg
